        ...
        <div className="flex justify-between items-center mb-20 relative">
          ...
          {steps.map((step) => (
            <div key={step.number} className="relative z-10">
              ...
              <div className="absolute top-14 left-1/2 -translate-x-1/2 text-xs text-gray-400 whitespace-nowrap monty uppercase">
                {step.title}
              </div>
            </div>
          ))}
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className=" text-gray-300 text-[15.5px font-medium mb-2 flex items-center">
                ...
                <div>
                  <label className=" text-gray-300 text-[15.5px font-medium mb-2">
                    Your Role
                  </label>
                  <select
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                {/* Pricing Options */}
                <div>
                  <label className="block text-gray-300 text-[15.5px font-medium mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <div className="text-[15.5px text-gray-400">
          ...
          <div className="flex justify-between items-center mt-16 pt-6 border-t border-white/10">
            ...
            {currentStep < 4 ? (
              ...
              <button
                ...
                className="flex items-center space-x-2 px-8 py-3 bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-lg hover:from-green-600 hover:to-blue-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25"
              >
